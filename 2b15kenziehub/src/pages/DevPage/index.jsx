...
import ModalTech from '../../components/modal-tech'
import ModalTrabalhos from '../../components/modal-trabalhos'
        ...
        <div className='big-container'>
            ...
            <div className='big-section'>
                ...
                <div className='cabecalho-tech'>
                        ...
                        >
                            <Box>
                                <ModalTech newTechs={newTechs} setOpen={setOpen}></ModalTech>
                            </Box>
                        </Modal>
                ...
                <div className='meus-trabalhos'>
                    <div className='cabecalho-trabalhos'>
                        ...
                        >
                            <Box>
                            <ModalTrabalhos newTrab={newTrab} setOpen={setOpen2}></ModalTrabalhos> 
                            </Box>
                        </Modal>
